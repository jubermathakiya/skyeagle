...
@section('content')
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 mx-auto">
                        ...
                        <div class="banner-content wow fadeInUp" data-wow-delay="0.3">
                            ...
                            <h6 class="text-white mx-auto">Explore stunning destinations and world-class experiences
                                aboard our award-winning ships</h6>
                        </div>
    ...
    <section class="section destination-section">
        <div class="container">
                ...
                <div class="col-xl-6 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                    <div class="section-header text-center">
                        <h2 class="mb-2">Explore Our <span class="text-primary  text-decoration-underline">Cruise
                                Types</span> </h2>
                        <p class="sub-title">Find the perfect cruise experience tailored to your unique interests and
                            travel style.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center view-all wow fadeInUp">
                <a href="{{url('cruise-grid')}}" class="btn btn-primary">More Categories<i
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="section-header mb-4  wow fadeInUp">
                        <h2 class="mb-2">Discover <span class="text-primary  text-decoration-underline">Who We
                                Are</span></h2>
                        <p class="sub-title">At DreamsTour, we are passionate about turning your dream vacation into a
                            reality. With years of experience in the cruise industry, we specialize in offering a wide
                            range of cruise options tailored to meet your preferences, whether
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <p>We partner with top cruise lines to offer a diverse selection of cruise
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12  wow fadeInUp">
                            <a href="{{url('about-us')}}" class="btn btn-primary">More About Us <i
                                    class="isax isax-arrow-right-3 ms-2"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                    <div class="section-header text-center">
                        ...
                        <p class="sub-title">Embark on unforgettable journeys to the world's most sought-after cruise
                            ports</p>
                    </div>
                </div>
            </div>
    ...
    <section class="section bgwhite">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                    <div class="section-header text-center">
                        ...
                        <p class="sub-title">Discover our handpicked selection of top-rated cruises, offering
                            exceptional experiences and unbeatable deals.</p>
                    </div>
                </div>
            </div>
            <!-- Cruise List -->
            <div class="owl-carousel place-slider nav-center  wow fadeInUp">
                ...
                <div class="place-item border mb-4">
                    ...
                    <div class="place-content">
                        ...
                        <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Broad Street,
                            Bristol</p>
                        <div class="guest-details">
                            <ul>
                                <li>
                ...
                <div class="place-item border mb-4">
                    ...
                    <div class="place-content">
                        ...
                        <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Chapel Street,
                            Salford</p>
                        <div class="guest-details">
                            <ul>
                                <li>
            ...
            <div class="text-center view-all wow fadeInUp">
                <a href="{{url('cruise-list')}}" class="btn btn-primary">View All<i
                        class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        </div>
    </section>
                ...
                <div class="col-xl-6 col-lg-10 text-center">
                    <div class="section-header text-center  wow fadeInUp">
                        <h2 class="mb-2">What’s Our <span class="text-primary  text-decoration-underline">User</span>
                            Says</h2>
                        <p class="sub-title">Explore heartfelt stories from our satisfied travelers, showcasing
                            unforgettable journeys and remarkable memories</p>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between text-center flex-column">
                            ...
                            <p class="mb-3">Dream Tours is the only way to go. We had the time of our life on our trip
                                to the Ark. The customer service was wonderful, and the staff was very helpful.</p>
                            <div class="d-flex align-items-center">
                ...
                <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between text-center flex-column">
                            ...
                            <p class="mb-3">We had a fantastic time as a family. There were activities for every age
                                group, and the kids loved the onboard kids’ club. The cruise gave us the perfect
                                relaxation & fun.</p>
                            <div class="d-flex align-items-center">
                                <a href="#" class="avatar avatar-md  flex-shrink-0">
                                    <img src="{{URL::asset('build/img/users/user-02.jpg')}}" class="rounded-circle" alt="img">
                ...
                <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between flex-column">
                            ...
                            <p class="mb-3"> was blown away by the variety of dining options and live shows every night.
                                It felt like I was in a five-star hotel on the sea! I’m already planning my next cruise
                            </p>
                            <div class="d-flex align-items-center">
                                <a href="#" class="avatar avatar-md  flex-shrink-0">
                                    <img src="{{URL::asset('build/img/users/user-03.jpg')}}" class="rounded-circle" alt="img">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="getintouch-content pe-0">
                                    ...
                                    <p class="text-light mb-4">Have questions about destinations, onboard experiences,
                                        or special offers? Our team is here to guide you. Reach out and let's make your
                                        next adventure unforgettable!</p>
                                    <a href="{{url('contact-us')}}" class="btn btn-white">Contact Us<i
                                            class="isax isax-arrow-right-3 ms-2"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-4">
