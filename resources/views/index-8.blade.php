    ...
    <section class="section destination-section">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-md-4">
                    <div class="text-end">
                        <a href="{{url('tour-grid')}}" class="btn btn-dark sec-head-btn">View All Categories<i
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-truncate line-clamb-3">Ensure that the tour is available on
                                                the dates you plan to travel. Browse available tours in your
                                                destination.</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-truncate line-clamb-3">Upon arrival, check in at our
                                                reception. Our friendly staff will guide you through</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-truncate line-clamb-3">Make sure to be at the meeting point
                                                on time, Ask questions and enjoy the experience!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="cars-slider owl-dot-bottom owl-carousel wow fadeInUp" data-wow-delay="1.5">
                ...
                <div class="place-item mb-4 flex-fill">
                    ...
                    <div class="place-content">
                        ...
                        <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Deansgate,
                            Manchester</p>
                        <div class="mb-3">
                            <h6 class="d-flex align-items-center text-gray-6 fs-14 fw-normal">Starts From <span
                ...
                <div class="place-item mb-4 flex-fill">
                    ...
                    <div class="place-content">
                        ...
                        <div class="mb-3">
                            <h6 class="d-flex align-items-center text-gray-6 fs-14 fw-normal">Starts From <span
                                    class="ms-1 fs-18 fw-semibold text-primary">$450</span><span
                    ...
                    <div>
                        <div class="section-header-six mb-4 wow fadeInUp" data-wow-delay="1.5">
                            ...
                            <p>We offer a diverse range of Tours, from compact cars ideal for city driving to spacious
                                SUVs for family trips and luxurious models for special events.</p>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <a href="{{url('about-us')}}" class="btn btn-dark me-3">Get Started<i
                                    class="isax isax-arrow-right-3 ms-2"></i></a>
                        ...
                        <div class="row g-4">
                                ...
                                <div class="counter-item card shadow-none flex-fill mb-0">
                                    <div class="card-body">
                                        <h3 class="display-6 text-primary mb-2"><span
                                                class="counter text-dark">57</span>+</h3>
                            ...
                            <div class="col-md-4 d-flex">
                                <div class="counter-item card shadow-none flex-fill mb-0">
                                    <div class="card-body">
                                        <h3 class="display-6 text-primary mb-2"><span
                                                class="counter text-dark">7098</span>+</h3>
                            ...
                            <div class="col-md-4 d-flex">
                                <div class="counter-item card shadow-none flex-fill mb-0">
                                    <div class="card-body">
                                        <h3 class="display-6 text-primary mb-2"><span
                                                class="counter text-dark">67</span>+</h3>
                                        <p>Client Globally</p>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="section">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-md-4">
                    <div class="text-end">
                        <a href="{{url('team')}}" class="btn btn-dark sec-head-btn">View All Providers<i
                                class="isax isax-arrow-right-3 ms-2"></i></a>
                    </div>
                </div>
            </div>
            <div class="providers-slider owl-carousel owl-dot-bottom">
                <div class="card">
                    <div class="card-body text-center">
                        <a href="{{url('tour-details')}}" class="d-block mb-3"><img src="{{URL::asset('build/img/icons/hotel-logo-02.svg')}}"
                                class="rounded-circle w-auto m-auto" alt="Img"></a>
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <a href="{{url('tour-details')}}" class="d-block mb-3"><img src="{{URL::asset('build/img/icons/hotel-logo-01.svg')}}"
                                class="rounded-circle w-auto m-auto" alt="Img"></a>
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <a href="{{url('tour-details')}}" class="d-block mb-3"><img src="{{URL::asset('build/img/icons/hotel-logo-03.svg')}}"
                                class="rounded-circle w-auto m-auto" alt="Img"></a>
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <a href="{{url('tour-details')}}" class="d-block mb-3"><img src="{{URL::asset('build/img/icons/hotel-logo-04.svg')}}"
                                class="rounded-circle w-auto m-auto" alt="Img"></a>
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <a href="{{url('tour-details')}}" class="d-block mb-3"><img src="{{URL::asset('build/img/icons/providers-logo.svg')}}"
                                class="rounded-circle w-auto m-auto" alt="Img"></a>
                        <h5 class="mb-2"><a href="{{url('tour-details')}}">Mystery Manor</a></h5>
                        <div class="d-flex align-items-center seperate-dot justify-content-center">
                            <span>Adventure Tours</span>
                    ...
                    <div class="testi-info-six">
                        ...
                        <div>
                            ...
                            <p class="mb-4 testi-para">I had an I recently booked a flight through, and I couldn’t be
                                ...
                                fees during checkout that weren’t clearly stated upfront.
                            </p>
                    ...
                    <div class="tourism-text-info">
                        <div class="text-header">
                            <h2>Trusted Solution Of Your <span class="text-primary"> <img
                                        src="{{URL::asset('build/img/tours/tour-img.jpg')}}" alt="Img"> Tourism</span> Services</h2>
                        </div>
    ...
    <section class="section blog-section blog-sec-six">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-md-4">
                    <div class="text-end">
                        <a href="{{url('blog-grid')}}" class="btn btn-dark sec-head-btn">View All Blogs<i
                                class="isax isax-arrow-right-3 ms-2"></i></a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-6">
                    <div class="card shadow-none blog-grid-six">
                        ...
                        <div class="card-body">
                            <h5 class="mb-2"><a href="{{url('blog-details')}}">It empowers designers to swiftly created</a>
                            </h5>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 d-flex">
                                <div class="card-body ps-md-0 flex-fill">
                                    <h5 class="mb-2"><a href="{{url('blog-details')}}">It empowers designers to swiftly
                                            created</a></h5>
