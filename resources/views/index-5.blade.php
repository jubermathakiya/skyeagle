        ...
        <div class="container">
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="card border-0 shadow-none pickup-card bg-secondary-100 flex-fill">
                        <div class="card-body">
                            ...
                            <p>Choose locations and times that suit your schedule. Well-maintained, modern vehicles
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="card border-0 shadow-none pickup-card bg-purple-100 flex-fill">
                        <div class="card-body">
                            ...
                            <p>Special rates and services for businesses, making travel easier for employe.Streamlined
                                invoicing for business rentals.</p>
                        </div>
                    </div>
                </div>
                <!-- /Business Travel -->
                ...
                <div class="col-lg-4 col-md-6 d-flex">
                    <div class="card border-0 shadow-none pickup-card bg-teal-100 flex-fill">
                        <div class="card-body">
                            ...
                            <p>Rent by the hour, day, week, or month, depending on your needs. Availability for
                                spontaneous trips or urgent needs.</p>
                        </div>
                    </div>
                </div>
                <!-- /Pick-Up & Drop-Off -->
            ...
            <div class="category-wrapper">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                        <div class="section-header text-center">
                            ...
                            <p class="sub-title">Gaining popularity due to advancements in battery technology and
                                growing environmental awareness</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center view-all wow fadeInUp">
                    <a href="{{url('car-grid')}}" class="btn btn-dark">View All<i
                ...
                <div class="col-lg-6 wow fadeInDown">
                    <div class="section-header mb-4">
                        <h6 class="fs-14 fw-medium text-primary d-flex align-items-center mb-2"><i
                                class="isax isax-trend-up me-1"></i>Get to know about Us</h6>
                        <h2 class="mb-2">Provide high-quality vehicles & service to make your journeys seamless &
                            enjoyable.</h2>
                        <p class="sub-title">We offer a diverse range of vehicles, from compact cars ideal for city
                            driving to spacious SUVs for family trips and luxurious models for special events. All our
                            cars are well-maintained, regularly serviced</p>
                    </div>
                    <div class="mb-3 border-bottom">
                        <div class="mb-3">
                            <h6 class="d-flex align-items-center"><i
                                    class="isax isax-tick-circle5 text-teal fs-24 me-2"></i>Convenient Locations</h6>
                            <p>Multiple pick-up and drop-off locations to suit your travel plans.</p>
                        </div>
                        <div class="mb-3">
                            <h6 class="d-flex align-items-center"><i
                                    class="isax isax-tick-circle5 text-orange fs-24 me-2"></i>Customer-Centric Service
                            </h6>
                            <p>Our team is always ready to assist you with any inquiries or needs.</p>
                        </div>
                        <div class="mb-3">
                            <h6 class="d-flex align-items-center"><i
                                    class="isax isax-tick-circle5 text-purple fs-24 me-2"></i>Safety First</h6>
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-3 mb-0 mb-md-4 mb-lg-0">
                        <a href="{{url('add-car')}}" class="btn btn-dark d-inline-flex align-items-center"><i
                                class="isax isax-add-circle5 me-2"></i>Add Your Car</a>
                        <a href="{{url('car-grid')}}" class="btn btn-primary d-inline-flex align-items-center"><i
                                class="isax isax-calendar-2 me-2"></i>Book a Car</a>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                    <div class="section-header text-center">
                        ...
                        <p class="sub-title">Gaining popularity due to advancements in battery technology and growing
            ...
            <div class="owl-carousel cars-slider owl-dot-bottom">
                ...
                <div class="place-item mb-4 flex-fill">
                    ...
                    <div class="place-content">
                        ...
                        <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Ciutat Vella,
                            Barcelona</p>
                        ...
                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                            <div class="d-flex flex-wrap align-items-center me-2">
                                <h5 class="text-primary">$500 <span class="fs-14 text-gray-6 fw-normal">/ day</span>
                                </h5>
                            </div>
                ...
                <div class="place-item mb-4 flex-fill">
                    ...
                    <div class="place-content">
                        ...
                        <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Oxford Street,
                            London</p>
                        <div class="mb-3 p-2 border rounded d-flex align-items-center justify-content-between">
                            <div class="pe-4 border-end">
                                <span class="fs-14 d-flex align-items-center text-dark"><i
                        ...
                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                            <div class="d-flex flex-wrap align-items-center me-2">
                                <h5 class="text-primary">$600 <span class="fs-14 text-gray-6 fw-normal">/ day</span>
                                </h5>
                            </div>
                            <div class="ms-2 d-flex align-items-center">
                                <div class="d-flex align-items-center flex-wrap">
                ...
                <div class="place-item mb-4 flex-fill">
                    ...
                    <div class="place-content">
                        ...
                        <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Princes
                            Street, Edinburgh</p>
                        <div class="mb-3 p-2 border rounded d-flex align-items-center justify-content-between">
                            <div class="pe-4 border-end">
                                <span class="fs-14 d-flex align-items-center text-dark"><i
                        ...
                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                            <div class="d-flex flex-wrap align-items-center me-2">
                                <h5 class="text-primary">$300 <span class="fs-14 text-gray-6 fw-normal">/ day</span>
                                </h5>
                            </div>
                            <div class="ms-2 d-flex align-items-center">
                                <div class="d-flex align-items-center flex-wrap">
                ...
                <div class="place-item mb-4 flex-fill">
                    ...
                    <div class="place-content">
                        ...
                        <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>King’s Road,
                            Chelsea</p>
                        <div class="mb-3 p-2 border rounded d-flex align-items-center justify-content-between">
                            <div class="pe-4 border-end">
                                <span class="fs-14 d-flex align-items-center text-dark"><i
                        ...
                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                            <div class="d-flex flex-wrap align-items-center me-2">
                                <h5 class="text-primary">$550 <span class="fs-14 text-gray-6 fw-normal">/ day</span>
                                </h5>
                            </div>
                            <div class="ms-2 d-flex align-items-center">
                                <div class="d-flex align-items-center flex-wrap">
                ...
                <div class="place-item mb-4 flex-fill">
                    ...
                    <div class="place-content">
                        ...
                        <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>Bold Street,
                            Liverpool</p>
                        <div class="mb-3 p-2 border rounded d-flex align-items-center justify-content-between">
                            <div class="pe-4 border-end">
                                <span class="fs-14 d-flex align-items-center text-dark"><i
                        ...
                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                            <div class="d-flex flex-wrap align-items-center me-2">
                                <h5 class="text-primary">$450 <span class="fs-14 text-gray-6 fw-normal">/ day</span>
                                </h5>
                            </div>
                            <div class="ms-2 d-flex align-items-center">
                                <div class="d-flex align-items-center flex-wrap">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-xxl-6 col-lg-4 d-none d-lg-flex">
                    <div class="text-center flex-fill d-flex align-items-center justify-content-center wow zoomIn"
                        data-wow-delay="1s">
                        <div class="work-img">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                    <div class="section-header text-center">
                        ...
                        <p class="sub-title">Discover the most popular locations for car rentals and find the perfect
                            destinations to suit your travel needs.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="owl-carousel testimonial-slider-three owl-dot-bottom">
                ...
                <div class="card wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-body">
                        ...
                        <p class="three-line-ellipsis mb-3">Dream Tours is the only way to go. We had the time of our
                            life on our trip to the Ark. The customer service was wonderful, and the staff was very
                            helpful.</p>
                ...
                <div class="card wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-body">
                        ...
                        <p class="three-line-ellipsis mb-3">Booking our dream cruise was incredibly easy with DreamsTour
                            The interface was user-friendly, and I loved how we could compare different cruise lines.
                        </p>
                        <div class="d-flex align-items-center border-top pt-3">
                            <a href="#" class="avatar avatar-md flex-shrink-0">
                ...
                <div class="card wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-body">
                        ...
                        <p class="three-line-ellipsis mb-3">Dream cruise was incredibly easy with DreamsTour The
                            interface was user-friendly, and I loved how we could compare different cruise lines.</p>
                        <div class="d-flex align-items-center border-top pt-3">
                            <a href="#" class="avatar avatar-md flex-shrink-0">
                ...
                <div class="card wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-body">
                        ...
                        <p class="three-line-ellipsis mb-3">We had a fantastic time as a family. There were activities
                            for every age group, and the kids loved the kids’ club. The cruise gave us the relaxation
                            and fun.</p>
                        <div class="d-flex align-items-center border-top pt-3">
                            <a href="#" class="avatar avatar-md flex-shrink-0">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="section-header mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        <h2 class="text-white mb-2">Start Adding Cars With Our Exclusive & Updated Pricing Plans only
                            for you</h2>
                        <p class="text-light sub-title">Ask a Question To get Your Answers from Our DreamsTour
                            Management</p>
                    </div>
                        ...
                        <div class="accordion-item show mb-2 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div id="faq-collapseOne" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    <p class="mb-0">Simply enter your location, pick-up and drop-off dates, and search
                                        through the available options. Choose the car that fits your needs, and follow
                                        the steps to complete the booking. </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="blog-content">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <p class="fs-13 fw-medium d-flex align-items-center mb-2"><i
                                        class="isax isax-calendar-1 text-gray-9 fs-20 me-2"></i>27 Sep 2025</p>
                            </div>
                            <h5><a href="{{url('blog-details')}}">It empowers designers to swiftly created informative landing
                                    pages</a></h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item blog-wrap flex-fill wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="blog-content">
                            ...
                            <h5><a href="{{url('blog-details')}}">Want to be notified about new post and news from our Portal
                                    ?</a></h5>
                        </div>
                    </div>
                </div>
