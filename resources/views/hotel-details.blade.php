                        ...
                        <div class="row row-cols-lg-6 row-cols-sm-4 row-cols-2 g-2">
                            ...
                            <div class="col">
                                <div class="galley-wrap more-gallery d-flex align-items-center justify-content-center">
                                    <a data-fancybox="gallery" href="{{URL::asset('build/img/hotels/hotel-large-08.jpg')}}"
                                        class="btn btn-white btn-xs"><i class="isax isax-image5 me-1"></i>See All</a>
                                </div>
                            </div>
                        </div>
                    </div>
