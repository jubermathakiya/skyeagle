            ...
            <ul>
                ...
                <li>
                    <a href="{{ route('dashboard') }}"
                        class="d-flex align-items-center{{ $active === 'dashboard' ? ' active' : '' }}">
                ...
                <li class="mb-2">
                    <a href="{{ route('wishlist') }}"
                        class="d-flex align-items-center{{ $active === 'wishlist' ? ' active' : '' }}">
                ...
                <li>
                    <a href="{{ route('my-profile') }}"
                        class="d-flex align-items-center{{ $active === 'my-profile' ? ' active' : '' }}">
                ...
                <li>
                    <a href="{{ route('profile-settings') }}"
                        class="d-flex align-items-center{{ $active === 'profile-settings' ? ' active' : '' }}">
                ...
                <li>
                    <form action="{{ route('auth.logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="d-flex align-items-center pb-0 border-0 bg-transparent w-100">
                            <i class="isax isax-logout-15"></i>
