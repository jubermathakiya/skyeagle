                ...
                <div class="place-content">
                    <div class="d-flex align-items-center justify-content-between mb-1">
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <p class="fs-14 text-gray-9 text-truncate">{{ $package->category->name ?? '-' }}</p>
                        </div>
                    ...
                    <p class="d-flex align-items-center mb-3"><i class="isax isax-location5 me-2"></i>{{ $package->source_city }}, {{ $package->destination_city }}</p>
                    <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between border-top pt-3">
                        <div class="d-flex flex-wrap align-items-center me-2">
                            ...
                            <p class="fs-14 text-gray-9">{{ $package->duration['text'] ?? '-' }}</p>
                        </div>
                        <span class="d-inline-block border vertical-splits">
                            <span class="bg-light text-light d-flex align-items-center justify-content-center"></span>
                        </span>
