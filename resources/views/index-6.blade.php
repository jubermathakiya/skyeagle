...
@section('content')
                ...
                <div class="row align-items-center">
                    <div class="col-lg-10 col-md-12 mx-auto wow fadeInUp" data-wow-delay="0.3s">
                        <div class="banner-content text-center mx-auto">
                            <h1 class="text-white display-4 mb-2">Discover the World, One <span class="flight-icon"><img
                                        src="{{URL::asset('build/img/icons/flight-icon.svg')}}" alt="icon"></span> Flight at a Time with
                                DreamsTour!</h1>
                            <p class="text-white mx-auto">Your ultimate destination for all things help you celebrate &
                                remember tour experience.</p>
                    ...
                    <div class="tab-pane">
                        <form action="{{url('flight-grid')}}">
                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-2">
                                ...
                                <h6 class="fw-medium fs-16 mb-2">Millions of cheap flights. One simple search
                                </h6>
                            </div>
                                ...
                                <div class="d-lg-flex">
                                    <div class="d-flex  form-info">
                                        ...
                                        <div class="form-item dropdown">
                                            <div data-bs-toggle="dropdown" data-bs-auto-close="outside"
                                                aria-expanded="false" role="menu">
                                                <label class="form-label fs-14 text-default mb-1">Travellers and
                                                    cabin class</label>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-10 text-center wow fadeInUp" data-wow-delay="0.2s">
                    <div class="section-header section-header-four text-center">
                        ...
                        <p class="sub-title">Connecting Needs with Offers for the Professional Flight Services, Book
                            your next flight appointment with ease.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="section place-section">
        <div class="container">
                    ...
                    <div class="place-content">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <p class="fs-14 d-inline-flex align-items-center mb-0"><i
                                    class="fa-solid fa-circle fs-6 text-primary mx-2"></i>1-stop at Frankfurt</p>
                        </div>
                        <div class="date-info p-2 mb-3">
                            <p class="d-flex align-items-center"><i class="isax isax-calendar-2 me-2"></i>Sep 04, 2024 -
                                Sep 07, 2024</p>
                        </div>
                ...
                <div class="place-item mb-4">
                    ...
                    <div class="place-content">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <p class="fs-14 mb-0">Indigo</p>
                            <p class="fs-14 d-inline-flex align-items-center mb-0"><i
                                    class="fa-solid fa-circle fs-6 text-primary mx-2"></i>1-stop at Dallas</p>
                        </div>
                        <div class="date-info p-2 mb-3">
                            <p class="d-flex align-items-center"><i class="isax isax-calendar-2 me-2"></i>Sep 11, 2024 -
                                Sep 13, 2024</p>
                        </div>
                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                ...
                <div class="place-item mb-4">
                    ...
                    <div class="place-content">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <p class="fs-14 mb-0">Indigo</p>
                            <p class="fs-14 d-inline-flex align-items-center mb-0"><i
                                    class="fa-solid fa-circle fs-6 text-primary mx-2"></i>1-stop at Seoul</p>
                        </div>
                        <div class="date-info p-2 mb-3">
                            <p class="d-flex align-items-center"><i class="isax isax-calendar-2 me-2"></i>Sep 22, 2024 -
                                Sep 24, 2024</p>
                        </div>
                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                ...
                <div class="place-item mb-4">
                    ...
                    <div class="place-content">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <p class="fs-14 mb-0">Indigo</p>
                            <p class="fs-14 d-inline-flex align-items-center mb-0"><i
                                    class="fa-solid fa-circle fs-6 text-primary mx-2"></i>1-stop at London</p>
                        </div>
                        <div class="date-info p-2 mb-3">
                            <p class="d-flex align-items-center"><i class="isax isax-calendar-2 me-2"></i>Oct 17, 2024 -
                                Oct 19, 2024</p>
                        </div>
                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                ...
                <div class="place-item mb-4">
                    ...
                    <div class="place-content">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <p class="fs-14 mb-0">Indigo</p>
                            <p class="fs-14 d-inline-flex align-items-center mb-0"><i
                                    class="fa-solid fa-circle fs-6 text-primary mx-2"></i>1-stop at Doha</p>
                        </div>
                        <div class="date-info p-2 mb-3">
                            <p class="d-flex align-items-center"><i class="isax isax-calendar-2 me-2"></i>Aug 26, 2024 -
                                Aug 27, 2024</p>
                        </div>
                        <div class="d-flex align-items-center justify-content-between border-top pt-3">
                            <h6 class="text-primary"><span class="fs-14 fw-normal text-default">From </span>$300</h6>
            ...
            <div class="text-center view-all wow fadeInUp">
                <a href="{{url('flight-grid')}}" class="btn btn-dark">View All Flights<i
            ...
            <div class="row">
                <div class="col-lg-5 wow fadeInDown" data-wow-delay="0.2s">
                    <div class="section-header section-header-four mb-4">
                        <h2 class="mb-2"><span>Where comfort</span> meets elegance and every guest is treated like
                            family.</h2>
                        <p class="sub-title">Our mission is to create memorable experiences for our guests. We believe
                            that every stay should feel special, whether you’re here for business, leisure, or a special
                            occasion.</p>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-3 mb-0 mb-md-4 mb-lg-0">
                        <a href="{{url('add-flight')}}" class="btn btn-dark d-inline-flex align-items-center"><i
                                class="isax isax-add-circle5 me-2"></i>Add Flights</a>
                        <a href="{{url('flight-grid')}}" class="btn btn-primary d-inline-flex align-items-center"><i
                                class="isax isax-calendar-2 me-2"></i>Book a Flight</a>
                    ...
                    <div class="flex-fill position-relative">
                        ...
                        <div class="mb-4 mb-lg-0 success-wrap">
                            <div class="section-header section-header-four">
                                ...
                                <p class="sub-title">Read what our satisfied clients have to say about their experiences
                                    with our platform.</p>
                            </div>
                            ...
                            <div class="col-md-6 d-flex">
                                <div class="card flex-fill mb-0 wow fadeInDown" data-wow-delay="0.1s">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-2">I had an I recently booked a flight through [Booking
                                            Website/App], and I couldn’t be happier with the experience.</p>
                                        <div class="d-flex align-items-center">
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                            ...
                            <div class="col-md-6 d-flex">
                                <div class="card flex-fill mb-0 wow fadeInDown" data-wow-delay="0.2s">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-2">I did have a quick question about my itinerry, and customer
                                            service was incredibly helpful and responsive</p>
                                        <div class="d-flex align-items-center">
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                            ...
                            <div class="col-md-6 d-flex">
                                <div class="card flex-fill mb-0 wow fadeInDown" data-wow-delay="0.1s">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-2">After finally selecting a flight, I was hit with unexpected fees
                                            during checkout that weren’t clearly stated upfront.</p>
                                        <div class="d-flex align-items-center">
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                            ...
                            <div class="col-md-6 d-flex">
                                <div class="card flex-fill mb-0 wow fadeInDown" data-wow-delay="0.2s">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-2">I received my confirmation email almost immediately, and all the
                                            details were accurate.</p>
                                        <div class="d-flex align-items-center">
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                                            <i class="ti ti-star-filled text-primary me-1"></i>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="business-info">
                            <h2 class="display-6 text-white mb-3">Discover the easiest way to automate scheduling and
                                grow your business</h2>
                            <p class="text-light mb-4">Our comprehensive solution facilitates your salon operations, so
                                you can focus on what truly matters.</p>
                            <a href="{{url('add-flight')}}" class="btn btn-dark d-inline-flex align-items-center"><i
                                    class="isax isax-add-circle me-2"></i>Add Flights</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
    ...
    <section class="section blog-section blog-section-four pt-0">
        <div class="container">
            ...
            <div class="blog-slider owl-carousel nav-center">
                ...
                <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="blog-info text-center">
                        ...
                        <h5><a href="{{url('blog-details')}}">Understanding Airline Baggage Policies: What You Need to
                                Know</a></h5>
                    </div>
                </div>
                <!-- /Blog Item-->
                ...
                <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="blog-info text-center">
                        <span class="badge bg-primary mb-2">Times & Tips</span>
                        <h5><a href="{{url('blog-details')}}">Top Tips for Finding the Best Flight Deals All Year Round</a>
                        </h5>
                    </div>
                </div>
                <!-- /Blog Item-->
            ...
            <div class="text-center view-all wow fadeInUp">
                <a href="{{url('blog-grid')}}" class="btn btn-dark">View All Blogs<i
                        class="isax isax-arrow-right-3 ms-2"></i></a>
            </div>
        </div>
    </section>
